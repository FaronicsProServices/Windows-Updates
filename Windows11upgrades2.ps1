...
$windows11DownloadUrl = "https://go.microsoft.com/fwlink/?linkid=2165125"  # URL to download Windows 11 Installation Assistant
...
Function Check-SystemRequirements {
    ...
    # Check Secure Boot
    $secureBoot = (Get-WmiObject -Class Win32_BIOS).SecureBootEnabled
    if ($secureBoot) {
