...
# Upgrade arguments
$Arguments = "/auto upgrade /DynamicUpdate Disable /quiet"

# ---- Hardcoded domain credentials ----
$UserName = "DOMAIN\AdminUser"    # Replace with your domain\user
$Password = "SuperSecretPassword" # Replace with password
