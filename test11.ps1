...
function Get-ProfileFolders {
    ...
    Get-ChildItem -Path $root -Directory -Force | Where-Object {
        $_.Name -notin @('Public','Default','Default User','All Users') -and $_.Attributes -notmatch 'ReparsePoint'
    }
}
...
function Resize-CPartitionAndCreateNew {
    ...
    Format-Volume -DriveLetter $NewDriveLetter -FileSystem NTFS -NewFileSystemLabel "Profiles" -Confirm:$false
}
